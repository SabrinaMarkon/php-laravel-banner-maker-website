...
@section('content')
    ...
    <div class="form-page-medium">
        ...
        @if (count($contents) > 0)
            {{ Form::open(array('url' => 'maildownline/show', 'method' => 'GET', 'class' => 'form-horizontal')) }}
        ...
        @if (Session::has('mail'))
            ...
            {{ Form::open(array('route' => array('maildownline.update', Session::get('mail')->id), 'method' => 'PATCH')) }}
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-2">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        {{ Form::button('Return', array('class' => 'btn btn-custom', 'onclick' => "parent.location = 'maildownline'")) }}
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        {{ Form::open(array('route' => array('maildownline.destroy', Session::get('mail')->id), 'method' => 'DELETE')) }}
        ...
        @else
            ...
            {{ Form::open(array('route' => array('maildownline.store'), 'method' => 'POST')) }}
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-2">
